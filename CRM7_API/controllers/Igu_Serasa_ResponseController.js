...
const { igu_serasa_response_url } = require("../../URLs");
...
module.exports = {
  igu_serasa_response: async (acess_token, req, res, next) => {
    const u = req.body;
      ...
      try {
            ...
            formData.append("RespostaSerasaCrmAPIRequestIguana", '"' + mapZ + '"');
            ...
            axios
              ...
              .post(igu_serasa_response_url, formData, {
                headers: {
                  auth_type: "oauth",
