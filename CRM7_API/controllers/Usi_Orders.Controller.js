...
const { usi_orders_url } = require("../../URLs");
...
module.exports = {
  usi_orders: async (req, res) => {
    ...
    if (pickToken == false) {
      try {
        ...
        axios
          ...
          .then(function (response) {
            ...
            formData.append("PedidosCrmAPIRequestUsibras", '"' + mapZ + '"');
      ...
      formData.append("ProdutosCrmAPIRequestUsibras", '"' + mapZ + '"');
